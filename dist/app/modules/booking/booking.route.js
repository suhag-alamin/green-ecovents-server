...
router.patch('/:id', (0, auth_1.default)(client_1.UserRole.ADMIN, client_1.UserRole.SUPER_ADMIN), (0, validateRequest_1.default)(event_validation_1.BookingValidation.updateBookingZodSchema), booking_controller_1.BookingController.updateBookingController);

...
router.post('/', (0, auth_1.default)(client_1.UserRole.ADMIN, client_1.UserRole.SUPER_ADMIN), (0, validateRequest_1.default)(subscriber_validation_1.SubscriberValidation.addSubscriberZodSchema), subscriber_controller_1.SubscriberController.addSubscriberController);
...
router.get('/', subscriber_controller_1.SubscriberController.getSubscribersController);
